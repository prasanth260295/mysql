alter table ach_ware_house_entry modify SCREENING_USER varchar2(50);

ALTER TABLE ACCOUNT_APPLICATION ADD ACCOUNT_TITLE VARCHAR2(45);

ALTER TABLE DEPOSIT_ACCOUNT ADD ACCOUNT_TITLE VARCHAR2(45);

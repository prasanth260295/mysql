ALTER TABLE  POTENTIAL_EVENT_TARGET MODIFY (TRANSFEROR_PROD_TYPE   VARCHAR2(60) );

CREATE SEQUENCE  "PROD_CATEGORY_FEATURES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 
START WITH 300 CACHE 20 NOORDER  NOCYCLE ;
...
ALTER TABLE deposit ADD CONSECUTIVE_DAYS_OD NUMBER default 0;
ALTER TABLE deposit ADD NO_OF_DAYS_OD_YTD NUMBER default 0;

...
P.LAST_NAME CUST_LNAME, P.FIRST_NAME CUST_FNAME,
...
FROM  ACCOUNT AC,PARTY_ACCOUNT_ROLE_VW parv,address ad,
party_address pa,
...
ACCOUNT_STATEMENT_ADDRESS asa,ACCOUNT_STATEMENT_GENERATOR asg,ACCOUNT_OWNER ao,
        INSTITUTION BA,
        ...
        (SELECT * FROM PARTY_REGISTERED_IDS WHERE TYPE='Driver''s License') DRID,PERSON p,
...
p.party_id=ssn_tin.party_id and
p.party_id=drid.party_id(+) and

...
AS
  ...
  FROM transaction_posttoday tpt,
    ...
    entry_type e,
    branch br
  WHERE tpt.account_id   = d.ACCOUNT_id
  ...
  alter table transaction_posttoday modify(AUTO_TXNS_SEQ_ID NUMBER(20));
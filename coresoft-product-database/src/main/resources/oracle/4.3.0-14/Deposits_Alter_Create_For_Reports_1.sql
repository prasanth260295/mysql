ALTER TABLE ENTRY_TYPE ADD MAPPING_TRANCODE VARCHAR2(10);

CREATE TABLE REPORT_PRODUCT_MAPPING ("ID" NUMBER(20,5), "PRODUCT_TYPE_ID" VARCHAR2(10),"REPORT_NAME" VARCHAR2(150));

ALTER TABLE PARTY_INSTITUTION_ASSOCIATION ADD INTERNET_BANKING_OPTION VARCHAR2(100);

ALTER TABLE ACCOUNT_APPLICATION ADD FREQUENCY VARCHAR2(45);

ALTER TABLE DEPOSIT_ACCOUNT ADD FREQUENCY VARCHAR2(45);

ALTER TABLE DEPOSIT_ACCOUNT ADD NEXT_COMPOUNDING_DATE DATE;

alter table cycle_group_config add IS_MASTER NUMBER(1) default 0;

alter table entry_type add IS_REALTIME_POSTING NUMBER(1) default 0;

ALTER TABLE PARTY_ASSOC_DELUXE_CREDENTIAL ADD OFAC_DATA VARCHAR2(50);

ALTER TABLE DEPOSIT ADD OPT_IN_ATM NUMBER(2);

ALTER TABLE DEPOSIT ADD OPT_IN_INTERNET_BANKING NUMBER(2);

alter table dynamic_forms add STOP_PAY_GROUPID varchar(20);

CREATE TABLE NAICS_MASTER_LOOKUP
(
  ID NUMBER(20, 5) NOT NULL
, NAICS_ID VARCHAR2(10 BYTE) NOT NULL 
, NAICS_NAME VARCHAR2(100 BYTE) 
) ;

CREATE OR REPLACE VIEW DEPOSIT_ACCOUNT_VW AS SELECT da.customer_id,da.account_title,
    da.account_id,

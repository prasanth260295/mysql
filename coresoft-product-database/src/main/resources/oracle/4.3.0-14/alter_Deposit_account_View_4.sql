ALTER TABLE ACCOUNT ADD ACCOUNT_TITLE VARCHAR2(45);
ALTER TABLE DEPOSIT_ACCOUNT DROP COLUMN ACCOUNT_TITLE;

ALTER TABLE DEPOSIT_ACCOUNT DROP COLUMN FREQUENCY;
ALTER TABLE DEPOSIT_ACCOUNT DROP COLUMN NEXT_COMPOUNDING_DATE;


ALTER TABLE DEPOSIT ADD FREQUENCY VARCHAR2(45);
ALTER TABLE DEPOSIT ADD NEXT_COMPOUNDING_DATE DATE;

ALTER TABLE ACCOUNT_APPLICATION ADD FREQUENCY_CODE VARCHAR2(20);
ALTER TABLE ACCOUNT_APPLICATION ADD PERIOD_SELECTION VARCHAR2(20);
ALTER TABLE ACCOUNT_APPLICATION ADD WEEK_SELECTION VARCHAR2(20);
ALTER TABLE ACCOUNT_APPLICATION ADD MONTH_SELECTION VARCHAR2(20);
ALTER TABLE ACCOUNT_APPLICATION ADD DAY_SELECTION VARCHAR2(20);
ALTER TABLE ACCOUNT_APPLICATION ADD CALENDER_SELECTION VARCHAR2(20);

ALTER TABLE DEPOSIT ADD PRE_COMPOUND_ACCRUED_INTEREST NUMBER(20,5) DEFAULT 0.00;

-- For Reg CC
ALTER TABLE hold_payment_maintenance add HOLD_DAYS NUMBER(4) default 0;
ALTER TABLE hold_payment_maintenance add HOLD_SUB_TYPE VARCHAR(25);

ALTER TABLE hold_payment ADD HOLD_DAYS  NUMBER(4) default 0;

ALTER TABLE hold_payment ADD HOLD_SUB_TYPE VARCHAR(25);

ALTER TABLE PARTY_ASSOC_DELUXE_CREDENTIAL ADD (ID INT NOT NULL,VERIFICATION_DATE DATE);

ALTER TABLE PERSON ADD OPT_IN_POD NUMBER(2) default 0;

ALTER TABLE PERSON ADD NICK_NAME VARCHAR2(500);

ALTER TABLE ACCOUNT ADD PRINT_ON_STATEMENT NUMBER(2) default 0;

ALTER TABLE DEPOSIT ADD ALLOWED_TRANSACTION_TYPE VARCHAR2(100);

ALTER TABLE DEPOSIT ADD ALLOWED_TRANSACTION_AMOUNT VARCHAR2(100); 

ALTER TABLE REG_CC_HOLD_TYPE MODIFY HOLD_DAYS NUMBER(2) DEFAULT 0;

ALTER TABLE automatic_transfer_instruction ADD FREQUENCY_DESCRIPTION VARCHAR2(200);

alter table PROPERTY_BUSINESS_RULE add valid_values VARCHAR2(100) ;

ALTER TABLE naics_information MODIFY INDUSTRY_DESCRIPTION VARCHAR2(1000);

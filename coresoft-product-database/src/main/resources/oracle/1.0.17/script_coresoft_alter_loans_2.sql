ALTER TABLE  LOAN_ACCOUNT ADD (REVIEWER VARCHAR2(50));   
ALTER TABLE  LOAN_ACCOUNT ADD (ENTERED_BY VARCHAR2(50));
...
SELECT
	...
	LA."ACC_INSURANCE_REBATE",
	LA."LATE_CHRG_INDICATOR",
	LA."AUTO_DRAFT",
	LA."INT_BILLING_DATE",
	LA."PRINCIPAL_BILLING_DATE",
	LA."CLASS_CODE",
	LA."LAST_PAYMENT_DATE",
	LA."IS_AMORTIZED",
	LA."DAYS_IN_A_YEAR",
	LA."PERCENTAGE_PAYMENT_AMOUNT",
	LA."MAXIMUM_AMOUNT",
	LA."MINIMUM_AMOUNT",
	LA."MAX_LATE_CHARGE_PER_YEAR",
	LA."GRACE_PERIOD",
	LA."LATE_CHRG_YTD",
	LA."AMT_LC_WAIVED",
	LA."WAIVE_LATE_CHARGE",
	LA."LATE_CHARGE_FIXED_AMT",
	LA."LOAN_TYPE_ID",
	...
	LA."UNUSED_LINE_COMMITMENT_AMT",
	LA."FINANCIAL_STMT_EXP_DATE",
	LA."FINANCING_STMT_EXP_DATE",
	LA."PRINCIPAL_BILLED_AMT",
	LA."INTEREST_BILLED_AMT",
	LA."BILLED_CHARGE1_AMT",
	LA."BILLED_CHARGE2_AMT",
	LA."BILL_STATUS_CODE",
	LA."BILLED_LINE_C0MMITMENT_FEE",
	LA."BILLED_DEALER_INTEREST",
	...
	LA."PAID_LOAN_CLOCK",
	LA."ESCROW_PAST_DUE",
	LA."NON_ESCROW_PAST_DUE",
	LA."COUPON_STAT_DATE",
	LA."COUPON_THRU_DATE",
	LA."COUPON_FLAG",
	LA."FIXED_PAYMENT_CODE",
	LA."BEG_ESCROW_BAL",
	LA."DEPOSIT_TO_ESCROW",
	LA."ESCROW_DISBURSEMETS",
	LA."ESCROW_DISBURSEMENTS_IRS",
	...
	LA."PRE_PAID_AMOUNT",
	LA."BILLED_ESCROW_DUE",
	LA."DAILY_DEALER_INT_ACCRUAL",

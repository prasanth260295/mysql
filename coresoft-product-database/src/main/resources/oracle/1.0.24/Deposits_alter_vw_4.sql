--alter table deposit add (PRIOR_YEAR_INTEREST NUMBER(20,5) NULL,RETURNS_LAST_YR NUMBER(10,0) NULL,PRIOR_YEAR_FED_WITHHOLD_AMT NUMBER(20,5) NULL); 

alter table deposit add (NO_TIMES_EXCESS_REGD_RPT NUMBER(10,0) NULL);

CREATE OR REPLACE VIEW DEPOSIT_ACCOUNT_VW 
AS
SELECT
 DA.CUSTOMER_ID                    ,
 DA.ACCOUNT_ID                     ,
